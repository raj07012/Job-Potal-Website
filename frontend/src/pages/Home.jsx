...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      icon: '⚡',
      title: 'Quick Apply',
      desc: 'One-click applications with your saved resume and profile',
    },
    {
      icon: '📊',
      title: 'Track Applications',
      desc: 'Real-time status updates from pending to hired',
    },
    {
      icon: '🏢',
      title: 'Top Companies',
      desc: 'Connect with industry-leading companies across all domains',
    },
  ];
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            Find Your <span style={{ color: 'var(--accent)' }}>Dream Job</span>
            <br />
            Land It Fast
          </h1>
          <p
          ...
          >
            Connect with top recruiters, apply instantly, and track every
            application — all in one sleek platform.
          </p>
          <div
            className="hero-cta"
            style={{
          ...
          >
            {stats.map((s) => (
              <div key={s.label} style={{ textAlign: 'center' }}>
                ...
                <div
                  style={{ fontSize: 13, color: 'var(--text3)', marginTop: 4 }}
                >
                  {s.label}
                </div>
              </div>
